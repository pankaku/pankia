...
@implementation PNLeftSegmentButton
...
- (void)_init {
	UIImage* normalImage = [UIImage imageNamed:@"PNSegmentedControlImageOnLeft.png"];
	UIImage* selectedImage = [UIImage imageNamed:@"PNSegmentedControlImageOffLeft.png"];
