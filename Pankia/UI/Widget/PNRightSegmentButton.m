...
@implementation PNRightSegmentButton
...
- (void)_init {
	UIImage* normalImage = [UIImage imageNamed:@"PNSegmentedControlImageOnRight.png"];
	UIImage* selectedImage = [UIImage imageNamed:@"PNSegmentedControlImageOffRight.png"];
